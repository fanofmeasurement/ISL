...
summary(Auto)
##(1)有关系 
##(2)mpg的平均值为23.45，线性回归的RSE为4.906，有20.9248%的相对误差。R-squared为0.6059，说明60.5948%的mpg可以被horsepower解释 
##(3)线性回归系数小于零，说明mpg与horsepower之间的关系是负相关
predict(lm.fit, data.frame(horsepower=c(98)), interval="confidence")
predict(lm.fit, data.frame(horsepower=c(98)), interval="prediction")
##(4)结果24.47，置信区间是(23.97, 24.96) ；预测区间是(14.81, 34.12)
...
#(f)
##(a)中Multiple R-squared:  0.239,  Adjusted R-squared:  0.234
##(e)中Multiple R-squared:  0.239,  Adjusted R-squared:  0.235 ，可知两者拟合度差不多，而(e)稍微好点
